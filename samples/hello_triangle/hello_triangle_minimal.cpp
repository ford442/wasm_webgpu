...
bindGroupLayoutEntries.binding=0;
bindGroupLayoutEntries.visibility=WGPU_SHADER_STAGE_COMPUTE;
bindGroupLayoutEntries.type=1;
bindGroupLayoutEntries.layout.buffer=bufferBindingLayout1;
bindGroupLayoutEntries.binding=1;
bindGroupLayoutEntries.visibility=WGPU_SHADER_STAGE_COMPUTE;
bindGroupLayoutEntries.type=1;
bindGroupLayoutEntries.layout.buffer=bufferBindingLayout2;
...
bindGroupEntries.binding=0;
bindGroupEntries.resource=inputBuffer;
bindGroupEntries.binding=2;
bindGroupEntries.resource=outputBuffer;
