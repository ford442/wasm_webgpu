...
WGpuBufferMapCallback onBuffer=[](WGpuBuffer buffer,void *userData,WGPU_MAP_MODE_FLAGS WGPU_MAP_MODE_READ,0,bufferSize){
std::cout << "output: " << std::endl;
std::cout <<buffer << std::endl;
};
const float* output=wgpu_buffer_map_async(mapBuffer,onBuffer,0,WGPU_MAP_MODE_FLAGS WGPU_MAP_MODE_READ,0,bufferSize);
