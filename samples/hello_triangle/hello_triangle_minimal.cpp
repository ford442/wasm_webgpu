...
bindGroupLayoutEntry1.layout.buffer=bufferBindingLayout1;
	WGpuBindGroupLayoutEntry bindGroupLayoutEntry2={};
bindGroupLayoutEntry2.binding=1;
bindGroupLayoutEntry2.visibility=WGPU_SHADER_STAGE_COMPUTE;
bindGroupLayoutEntry2.type=1;
bindGroupLayoutEntry2.layout.buffer=bufferBindingLayout2;
bindGroupLayout=wgpu_device_create_bind_group_layout(device,{&bindGroupLayoutEntry1,&bindGroupLayoutEntry2},2);
...
bindGroupEntry1.resource=outputBuffer;
WGpuBindGroup bindGroup=wgpu_device_create_bind_group(device,bindGroupLayout,&bindGroupEntry1,2);
